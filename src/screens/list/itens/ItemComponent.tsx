...
const ItemComponent = ({index, item, onPress}: Props) => {

    const { theme } = useTheme()

  return (

    <Button key={index} onPress={onPress} style={tw`mb-3 p-2 gap-4 justify-start items-center rounded-[1.2rem] flex flex-row w-full bg-white dark:bg-slate-700`}>
